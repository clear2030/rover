    ...
    def do_GET(self):
        html = '''
           ...
           <form action="/" method="POST">
               <input type="submit" name="Stop" value="Stop" style="height:300px; width:300px; margin:0 auto; display:flex;">
               <br>
               <input type="submit" name="Forward" value="Forward" style="height:300px; width:300px; margin:0 auto; display:flex;">
               <br>
               <input type="submit" name="Left" value="Left" style="height:300px; width:300px; margin:0 auto; display:flex;">
               <input type="submit" name="Right" value="Right" style="height:300px; width:300px; margin:0 auto; display:flex;">
               <br>
